...
class getAdminControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.t7fOm1P'] ?? $container->load('get_ServiceLocator_T7fOm1PService'))->withContext('App\\Controller\\AdminController', $container));
