 ...
 */
final class Version20210208081849 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE offer (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, job_id INTEGER DEFAULT NULL, created_at DATETIME NOT NULL, department VARCHAR(255) NOT NULL COLLATE BINARY, description CLOB NOT NULL COLLATE BINARY, zipcode VARCHAR(255) NOT NULL COLLATE BINARY, city VARCHAR(255) NOT NULL COLLATE BINARY, contact_email VARCHAR(255) NOT NULL COLLATE BINARY, reference VARCHAR(255) NOT NULL COLLATE BINARY, latitude DOUBLE PRECISION NOT NULL, longitude DOUBLE PRECISION NOT NULL, company VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_29D6873EBE04EA9 FOREIGN KEY (job_id) REFERENCES job (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__offer AS SELECT id, job_id, created_at, department, description, zipcode, city, company, contact_email, reference, latitude, longitude FROM offer');
        $this->addSql('DROP TABLE offer');
        $this->addSql('CREATE TABLE offer (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, job_id INTEGER DEFAULT NULL, created_at DATETIME NOT NULL, department VARCHAR(255) NOT NULL, description CLOB NOT NULL, zipcode VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, contact_email VARCHAR(255) NOT NULL, reference VARCHAR(255) NOT NULL, latitude DOUBLE PRECISION NOT NULL, longitude DOUBLE PRECISION NOT NULL, company VARCHAR(255) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO offer (id, job_id, created_at, department, description, zipcode, city, company, contact_email, reference, latitude, longitude) SELECT id, job_id, created_at, department, description, zipcode, city, company, contact_email, reference, latitude, longitude FROM __temp__offer');
        $this->addSql('DROP TABLE __temp__offer');
        $this->addSql('CREATE INDEX IDX_29D6873EBE04EA9 ON offer (job_id)');
    }
