 ...
 */
final class Version20210208101435 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__offer AS SELECT id, job_id, created_at, department, description, zipcode, city, contact_email, reference, company, latitude, longitude FROM offer');
        ...
        $this->addSql('INSERT INTO offer (id, job_id, created_at, department, description, zipcode, city, contact_email, reference, company, latitude, longitude) SELECT id, job_id, created_at, department, description, zipcode, city, contact_email, reference, company, latitude, longitude FROM __temp__offer');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE offer');
        $this->addSql('CREATE TABLE offer (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, job_id INTEGER DEFAULT NULL, created_at DATETIME NOT NULL, department VARCHAR(255) NOT NULL, description CLOB NOT NULL, zipcode VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, company VARCHAR(255) DEFAULT NULL, contact_email VARCHAR(255) NOT NULL, reference VARCHAR(255) NOT NULL, latitude DOUBLE PRECISION DEFAULT NULL, longitude DOUBLE PRECISION DEFAULT NULL)');
